...
// Research orchestrator — runs 4 parallel research angles via Claude + Tavily
router.post('/', async (req, res) => {
  ...
  try {
    // Step 1: Generate search queries for each research angle
...
Return ONLY a JSON array of 4 strings, no other text. Example: ["query1", "query2", "query3", "query4"]`
    ...
    const outputLangInstruction = isThai
